...
var schemaSatellite = require('../models/satellite');
var Satellite = mongoose.model('Satellite', schemaSatellite);
...
// fs.writeFileSync('../data/satellites.json', JSON.stringify(satObjects))
